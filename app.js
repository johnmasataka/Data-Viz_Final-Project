...
config.chapters.forEach((record, idx) => {
  // hold each vignette, the chapter element will go in the container element
...
// Append the features element (with the vignettes) to the story element
...
//create the footer element and assigns it, its content based on the config.js file 
...
//create the map element with the attributes from the main section of the config.js file
...
// watch for any resizing of the screen to adjust our scrolling setup
